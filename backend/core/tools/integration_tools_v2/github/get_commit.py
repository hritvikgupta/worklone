        ...
        try:
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                if response.status_code in [200, 201, 204]:
                    ...
                    transformed_data["author"] = data.get("author")
                    transformed_data["committer"] = data.get("committer")
                    transformed_data["stats"] = data.get("stats")
                    transformed_data["files"] = data.get("files", [])
