...
class ConfluenceUpdateTaskTool(BaseTool):
    name = "confluence_update_task"
    ...
    async def execute(self, parameters: dict, context: dict = None) -> ToolResult:
        ...
        api_status = "todo" if status.lower() == "incomplete" else status
        
        url = f"https://{domain}/wiki/api/v2/inlineTasks/{task_id}"
