...
class WordPressDeleteMediaTool(BaseTool):
    ...
    async def execute(self, parameters: dict, context: dict = None) -> ToolResult:
        ...
        url = f"https://public-api.wordpress.com/rest/v1.1/sites/{parameters['siteId']}/media/{parameters['mediaId']}?force=true"
