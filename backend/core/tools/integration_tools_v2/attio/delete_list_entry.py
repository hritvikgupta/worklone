...
class AttioDeleteListEntryTool(BaseTool):
            ...
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                if response.status_code in [200, 201, 204]:
                    ...
                    try:
                        ...
                        error_msg = error_data.get("message", response.text or "Failed to delete list entry")
                    except Exception:
                        error_msg = response.text or "Failed to delete list entry"
