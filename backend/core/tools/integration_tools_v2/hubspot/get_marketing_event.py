...
class HubspotGetMarketingEventTool(BaseTool):
    name = "hubspot_get_marketing_event"
    ...
    async def execute(self, parameters: dict, context: dict = None) -> ToolResult:
        ...
        url = f"https://api.hubapi.com/marketing/v3/marketing-events/{parameters['eventId'].strip()}"
