...
class GoogleFormsListWatchesTool(BaseTool):
    name = "google_forms_list_watches"
    ...
    async def _resolve_access_token(self, context: dict | None) -> str:
        connection = await resolve_oauth_connection(
            "google-forms",
            context=context,
            context_token_keys=("google_forms_token",),
    ...
    async def execute(self, parameters: dict, context: dict = None) -> ToolResult:
        ...
        url = f"https://forms.googleapis.com/v1/forms/{form_id}/watches"
