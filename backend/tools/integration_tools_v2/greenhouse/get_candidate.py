...
class GreenhouseGetCandidateTool(BaseTool):
    name = "greenhouse_get_candidate"
    description = "Retrieves a specific candidate by ID with full details including contact info, education, and employment history"
    ...
    async def execute(self, parameters: dict, context: dict = None) -> ToolResult:
        ...
        candidate_id = parameters.get("candidateId", "").strip()
        url = f"https://harvest.greenhouse.io/v1/candidates/{candidate_id}"
