...
class HubspotUpdateAppointmentTool(BaseTool):
    name = "hubspot_update_appointment"
    ...
    def get_schema(self) -> dict:
        return {
            ...
            "properties": {
                ...
                "properties": {
                    "type": "object",
                    "description": "Appointment properties to update as JSON object (e.g., {\"hs_meeting_title\": \"Updated Call\", \"hs_meeting_location\": \"Zoom\"})",
                },
            },
            "required": ["appointmentId", "properties"],
        }
