...
class DiscordLeaveThreadTool(BaseTool):
    ...
    async def execute(self, parameters: dict, context: dict = None) -> ToolResult:
        ...
        url = f"https://discord.com/api/v10/channels/{parameters['threadId']}/thread-members/@me"
            ...
            async with httpx.AsyncClient(timeout=30.0) as client:
                ...
                if response.status_code in [200, 201, 204]:
                    try:
                        ...
                        data = {}
                    return ToolResult(success=True, output=response.text or "Left thread successfully", data=data)
                else:
