...
class CreateWorkflowTool(BaseTool):
    ...
    async def execute(self, parameters: dict, context: dict = None) -> ToolResult:
        ...
        actor_type = parameters.get("created_by_actor_type") or (context.get("actor_type") if context else "") or "katy"
        actor_id = parameters.get("created_by_actor_id") or (context.get("actor_id") if context else "") or "katy"
        actor_name = parameters.get("created_by_actor_name") or (context.get("actor_name") if context else "") or "Katy"
...
class ExecuteWorkflowTool(BaseTool):
    ...
    async def execute(self, parameters: dict, context: dict = None) -> ToolResult:
        store = WorkflowStore()
        actor_type = parameters.get("handoff_actor_type") or (context.get("actor_type") if context else "") or "katy"
        actor_id = parameters.get("handoff_actor_id") or (context.get("actor_id") if context else "") or "katy"
        actor_name = parameters.get("handoff_actor_name") or (context.get("actor_name") if context else "") or "Katy"
