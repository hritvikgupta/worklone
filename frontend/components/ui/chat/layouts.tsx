...
function FullMessenger({
  ...
  return (
    <ChatProvider currentUser={currentUser} theme={theme} className="h-full w-full flex-1">
      <div className={cn("flex h-full w-full bg-[var(--chat-bg-app)]", className)}>
        {/* Sidebar — 320px */}
        ...
        {/* Main panel */}
        <main className="flex flex-1 flex-col min-w-0 bg-[var(--chat-bg-main)]">
          {activeConvo ? (
            <>
              <ChatHeader
