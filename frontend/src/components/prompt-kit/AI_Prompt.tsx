      ...
      <div className="rounded-2xl bg-white p-1.5 pt-4 dark:bg-white/5 shadow-sm border border-black/5">
        ...
        <div className="relative">
          <div className="relative flex flex-col">
            ...
            <div className="flex h-14 items-center rounded-b-xl bg-zinc-50 dark:bg-white/5">
              <div className="absolute right-3 bottom-3 left-3 flex w-[calc(100%-24px)] items-center justify-between">
                <div className="flex items-center gap-2">
                  <DropdownMenu>
                    <DropdownMenuTrigger asChild>
                      <Button
                        className="flex h-8 items-center gap-1 rounded-md pr-2 pl-1 text-xs hover:bg-black/5 focus-visible:ring-1 focus-visible:ring-blue-500 focus-visible:ring-offset-0 dark:text-white dark:hover:bg-white/10"
                        variant="ghost"
                      >
