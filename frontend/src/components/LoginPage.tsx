...
import { ArrowLeft, ArrowRight, Check, Mail, Building2, User } from 'lucide-react';
          ...
          <div className="grid w-full max-w-6xl gap-12 lg:grid-cols-[minmax(0,1.15fr)_minmax(420px,0.85fr)] lg:items-start">
            ...
            >
              ...
              <p className="mt-5 text-xs leading-5 text-zinc-400">
                By joining, you agree to receive product updates related to early access. No spam and
                no direct browser-side database access. Submissions are recorded server-side.
              </p>
            </motion.div>
          </div>
        </div>
